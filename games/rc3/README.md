...
- The game config (config_RC3.mk) for game target specific settings.
...
some patches to change behavior of some library calls that determine the game content paths for the game. Only the rc3.txt
